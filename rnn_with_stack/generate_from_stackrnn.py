...
DATAFILE = "stack-rnn-theano-100-82-2015-12-13-13-44-32.npz"
...
MODEL = load_model_parameters_stackrnn('saved_model_parameters/{0}'.format(DATAFILE), char_to_code_dict=char_to_code_dict)
