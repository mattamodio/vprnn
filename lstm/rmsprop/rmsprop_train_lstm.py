...
from rmsprop_generate_from_lstm import generate_sentence
...
print "Training Rmsprop LSTM with parameters:\
...
def main():
    ...
    model = LSTMTheano(ALPHABET_LENGTH, hidden_dim=_HIDDEN_DIM, minibatch_size=MINIBATCH_SIZE, bptt_truncate=SEQUENCE_LENGTH, momentum=MOMENTUM)
