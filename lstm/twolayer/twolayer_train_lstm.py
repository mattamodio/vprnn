...
from twolayer_lstm_theano import LSTMTheano
from twolayer_generate_from_lstm import generate_sentence
...
print "Training Two-Layer LSTM with parameters:\
...
def train_with_sgd(model, X_train, y_train, learning_rate=0.001, nepoch=1, evaluate_loss_after=1, num_sentences=5):
    ...
    for epoch in range(nepoch):
        ...
        if (epoch % evaluate_loss_after == 0):
            ...
            save_model_parameters_lstm("saved_model_parameters/lstm_twolayer-theano-%d-%d-%s.npz" % (model.hidden_dim, model.word_dim, time), model)
