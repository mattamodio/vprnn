...
#_MODEL_FILE = os.environ.get('MODEL_FILE', 'saved_model_parameters/lstm_with_stack-theano-500-82-2016-02-15-14-11-47.npz')
...
def main():
    ...
    push_vec = one_hot(char_to_code_dict[PUSH_CHAR], ALPHABET_LENGTH+1)
    pop_vec = one_hot(char_to_code_dict[POP_CHAR], ALPHABET_LENGTH+1)
